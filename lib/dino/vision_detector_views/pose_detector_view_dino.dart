...
class PoseDetectorViewDino extends StatefulWidget {
  const PoseDetectorViewDino({super.key});

  @override
  State<StatefulWidget> createState() => _PoseDetectorViewDinoState();
}

class _PoseDetectorViewDinoState extends State<PoseDetectorViewDino> {
  int i = 1;
  double standing = 0;
  int squatno = 0;
  int frame = 0;
